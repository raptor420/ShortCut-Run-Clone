namespace Dreamteck.Splines.Editor
{
    ...
    public class WelcomeScreen : WelcomeWindow
    {
        ...
        {
            base.Load();
            SetTitle("Splines " + PluginInfo.version, "");
            ...
            panels[0].elements.Add(new WindowPanel.Thumbnail("Utilities/Editor/Images", "get_started", "Get Started", "Learn how to use Splines in a matter of minutes", new ActionLink(panels[2], panels[0])));
            ...
            panels[0].elements.Add(new WindowPanel.Thumbnail("Utilities/Editor/Images", "rate", "Rate", "If you like Splines, please consider rating it on the Asset Store", new ActionLink("https://u3d.as/sLk")));
            panels[0].elements.Add(new WindowPanel.Space(400, 20));
            panels[0].elements.Add(new WindowPanel.Thumbnail("Utilities/Editor/Images", "playmaker", "Playmaker Actions", "Install Playmaker actions for Splines", new ActionLink(panels[5], panels[0])));
